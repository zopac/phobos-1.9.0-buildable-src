...
public class Cosmetics extends Module
{
    ...
    public Cosmetics() {
        super("Cosmetics", "Bitch", Category.CLIENT, true, false, false);
    ...
    public void onRenderPlayer(final RenderPlayerEvent.Post event) {
        ...
        for (final ModelBase model : Phobos.cosmeticsManager.getRenderModels(event.getEntityPlayer())) {
            ...
            final float rotate4 = MathHelper.cos(event.getEntityPlayer().limbSwing * 0.6662f + 3.1415927f) * 1.4f * limbSwingAmount / 1.0f;
    ...
    public class ModelBetterPhysicsCape extends ModelBase
    {
        ...
        public ModelBetterPhysicsCape() {
            ...
            for (int i = 0; i < 160; ++i) {
                final ModelRenderer segment = new ModelRenderer((ModelBase)this, 0, i);
        ...
        public void render(final Entity entity, final float f, final float f1, final float f2, final float f3, final float f4, final float f5) {
            for (final ModelRenderer model : this.boxList) {
                GlStateManager.pushMatrix();
